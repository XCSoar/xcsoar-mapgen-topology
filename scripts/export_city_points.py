...
sql_small = "SELECT * FROM reduced_cities;"

# Fetch the geometries from the database and create GeoDataFrames
gdf_small = gpd.GeoDataFrame.from_postgis(sql_small, conn, geom_col="geom")

# Set the output shapefile paths
output_dir = "out/"
output_shapefile_small = output_dir + "city_point.shp"
